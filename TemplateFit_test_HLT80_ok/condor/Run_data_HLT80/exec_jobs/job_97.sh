...
root -b -q -l "/grid_mnt/vol_home/llr/cms/shatat/CMSAnalysis/eec_2b_analysis/Test_vs_Zoe_code/Zoe_version/eec_2b_analysis-main/condor/common_condor_header/run_condor_job.C+(97, 100, 0, 80, 140, 1, 1, 0, 1)"
