...
public :
   ...
   Float_t         discr_unifiedParticleTransformer_probb[500];
   Float_t         discr_unifiedParticleTransformer_problepb[500];
   Float_t         discr_unifiedParticleTransformer_probbb[500];
   ...
   //HLT selection
   Int_t           HLT_AK4PFJet40_v8; // Run3 
   Int_t           HLT_AK4PFJet60_v8; // Run3 
   Int_t           HLT_AK4PFJet80_v8; // Run3 
   Int_t           HLT_AK4PFJet100_v8; // Run3 
   Int_t           HLT_AK4PFJet120_v8; // Run3 
   // and their prescales 
   Int_t          HLT_AK4PFJet40_v8_PrescaleNumerator; // Run3 
   Int_t          HLT_AK4PFJet40_v8_PrescaleDenominator; // Run3
   Int_t          HLT_AK4PFJet60_v8_PrescaleNumerator; // Run3 
   Int_t          HLT_AK4PFJet60_v8_PrescaleDenominator; // Run3
   Int_t          HLT_AK4PFJet80_v8_PrescaleNumerator; // Run3 
   Int_t          HLT_AK4PFJet80_v8_PrescaleDenominator; // Run3
   Int_t          HLT_AK4PFJet100_v8_PrescaleNumerator; // Run3 
   Int_t          HLT_AK4PFJet100_v8_PrescaleDenominator; // Run3
   Int_t          HLT_AK4PFJet120_v8_PrescaleNumerator; // Run3 
   Int_t          HLT_AK4PFJet120_v8_PrescaleDenominator; // Run3
...
void tTree::Init(TString rootf, bool isMC)
{
   ...
   */
   ...
   // -- and there prescale
   tree->SetBranchAddress("HLT_AK4PFJet40_v8_PrescaleNumerator", &HLT_AK4PFJet40_v8_PrescaleNumerator, &b_HLT_AK4PFJet40_v8_PrescaleNumerator);
   tree->SetBranchAddress("HLT_AK4PFJet60_v8_PrescaleNumerator", &HLT_AK4PFJet60_v8_PrescaleNumerator, &b_HLT_AK4PFJet60_v8_PrescaleNumerator);
   tree->SetBranchAddress("HLT_AK4PFJet80_v8_PrescaleNumerator", &HLT_AK4PFJet80_v8_PrescaleNumerator, &b_HLT_AK4PFJet80_v8_PrescaleNumerator);
   tree->SetBranchAddress("HLT_AK4PFJet100_v8_PrescaleNumerator", &HLT_AK4PFJet100_v8_PrescaleNumerator, &b_HLT_AK4PFJet100_v8_PrescaleNumerator);
   tree->SetBranchAddress("HLT_AK4PFJet120_v8_PrescaleNumerator", &HLT_AK4PFJet120_v8_PrescaleNumerator, &b_HLT_AK4PFJet120_v8_PrescaleNumerator);
