...
void run_condor_job_Run3(Int_t job_idx, Int_t n_jobs,
  ...
  TString output_folder = "/home/llr/cms/shatat/CMSAnalysis/eec_2b_analysis/condor_Run3_testTChain/JobResult/";
  TString domain = ".root";
  ...
  if(RunN == 3) {
    ...
    output_folder = "/home/llr/cms/shatat/CMSAnalysis/eec_2b_analysis/condor_Run3_testTChain/JobResult/";
    ...
    if (!isMC && dataType > 1) {
      ...
      output_hist = Form("%s_secondbinsplitting_June_WP0872_template_for_fit_histos_3D_data_allfiles0_4", RunN_str.Data());
      ...
      // -- Corrected file: QCD
        ...
        output_hist = Form("%s_secondbinsplitting_June_WP0872_template_for_fit_histos_3D_qcd_allfiles0_9", RunN_str.Data());
