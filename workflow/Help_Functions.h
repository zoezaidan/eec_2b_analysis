...
// ============================================================================
// compare_root_contents() -- moved in from compare_root_contents.C on 2026-09-25 to keep
// the number of files down; unchanged.
// ============================================================================
#include <TKey.h>
...
//   root -l -b -q -e '#include "Help_Functions.h"' -e 'compare_root_contents("a.root","b.root")'
